...
export const keycodeKeysyms: KeyCodeKeysyms = {
	8: [0xff08], // backspace
	9: [0xff09], // tab
...
export const keyidentifier_keysym: KeyIdentifierKeysym = {
	Again: [0xff66],
...
export const OSK_keyMappings: [string, number, string, string, number][] = [
	['!', 49, 'Digit1', '!', 0],
	['#', 51, 'Digit3', '#', 0],
	['$', 52, 'Digit4', '$', 0],
	['%', 53, 'Digit5', '%', 0],
